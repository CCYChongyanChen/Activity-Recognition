...
#                        print(label.values[0])
        ...
        try:
            cv2.putText(image,"Prdeiction:"+str(predic), (10, 20),  cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
        except:
            
            cv2.putText(image,"Prdeiction:", (10, 40),  cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2)
...
if __name__ == '__main__':
    csv_path='/home/chongyan/activity_recognition/Final_project/IMG_2431.csv'
    video_path='/home/chongyan/activity_recognition/Final_project/IMG_2431.MOV'
