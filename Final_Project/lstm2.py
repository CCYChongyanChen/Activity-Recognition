...
def train_model(train_x, train_y, test_x, test_y):
    ...
    try:
        ...
        model.fit(train_x, train_y, batch_size=1024, nb_epoch=100, validation_split=0.0001)
...
if __name__ == '__main__':
    ...
    file_name='/home/chongyan/activity_recognition/Final_project/Ershad_features.csv'
    sequence_length=10
    split=0.8
