    ...
    for idx, (csv_path, video_path) in enumerate(zip(csv_paths, video_paths)):
        ...
        while cap.isOpened():
            ...
            if len(humans) > 0:
                ...
                if label.size != 0:
                    cv2.putText(image,"Label: "+str(label.values[0]), (10, 70),  cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
            ...
            cv2.putText(image, "FPS: %f" % (1.0 / (time.time() - fps_time)), (10, 20),  cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
...
if __name__ == '__main__':
    csv_paths=['../../../Work/videos/RealData/Chongyan.csv', '../../../Work/videos/RealData/Tim.csv']
    video_paths=['../../../Work/videos/RealData/Chongyan.MOV', '../../../Work/videos/RealData/Tim.MOV']
    output_path='../../../Work/Project/features.csv'
    extract_frames(csv_paths,video_paths,output_path)
